...
#code filipipipipipipippipipipipipipipipipipipip
...
def chave_acesso():
    if validacaocpf == True:
        for i in range(4):
            ...
            break
        duasletras_nome = nome[:2]
        letras_sobrenome = sobrenome[0]
        print(f'{duasletras_nome}+{letras_sobrenome}+{digitos}')